...
/*else if(global_login($table_name="admin",$cond="where user_id='".$_SESSION['admin_id']."' and user_name='".$_SESSION['admin_name']."' and status='Y'")==false){
...
<body>
 ...
 <?php if($_REQUEST['msg']){?><p><?php echo $_REQUEST['msg'];?></p><?php } ?>
  ...
  <form name="loginform" id="loginform" class="login" action="lib/login.php" method="post">
 
    <p class="title">Login Panel</p>
     <input type="email" name="user_login" id="user_login" placeholder="Type your email.!"  size="28" class="input" autofocus required autocomplete="off"/>
    ...
    <i class="fa fa-key"></i>
    <a href="signup.php" id="">Create New account?</a>
    <button>
      <i class="spinner"></i>
